...
var MODULE_CONFIG = {
    ...
    dataTable:      [
                      ...
                      '/js/lib/dataTables/dataTables.bootstrap4.js',
                      '/css/lib/dataTables.bootstrap4.css',
                      '/js/lib/dataTables/datatable.js',
                    ],
    bootstrapTable: [
    ...
    bootstrapWizard:[
                      '/js/lib/jquery.bootstrap.wizard.min.js'
                    ],
    dropzone:       [
    ...
    datepicker:     [
                      ...
                      "/css/lib/bootstrap-datepicker.min.css",
                    ],
    daterangepicker:[
